...
main:
	...
	li $v0, 9
	syscall
	move $s0, $v0		# Endereço da matriz alocada
	li $v0, 9
	syscall
	move $s2, $v0
	move $a0, $s0
...
indice:
	...
	add $v0, $v0, $a3	# soma com o endereço base
	jr $ra
...
l:
	...
	addi $sp, $sp, 4	# Libera o espaço para a pilha
	move $v0, $a3		# Retorna o endereço base da matriz
	jr $ra			# Retorna para a main
	
escrita:
	addi $sp, $sp, -4	# Aloca espaço na pilha
	sw $ra, ($sp)		# Guarda o endereço de retorno pra main na pilha
	move $a3, $a0		# GUarda o endereço base de mat em $a3
...
rotaciona:
				# $a1 -> endereço da segunda matriz
	move $a3, $a0		# $a3 -> endereço da matriz base
				# $a2 -> tamanho n
	li $t0, 0		# i = 0 ; i <=> $t0
	li $t1, 0		# j = 0 ; j <=> $t1
	subi $sp, $sp, 4	# Espaço para 1 item na pilha
